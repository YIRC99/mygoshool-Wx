...
var _addShop = _interopRequireDefault(__webpack_require__(/*! ./subpkg/addShop.vue */ 175));
// @ts-ignore
...
/* harmony import */ var _addShop_vue_vue_type_template_id_5d77827c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addShop.vue?vue&type=template&id=5d77827c& */ 176);
/* harmony import */ var _addShop_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addShop.vue?vue&type=script&lang=js& */ 178);
...
/* harmony import */ var _addShop_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addShop.vue?vue&type=style&index=0&lang=scss& */ 180);
...
try {
  components = {
    ...
    uvTextarea: function () {
      return Promise.all(/*! import() | uni_modules/uv-textarea/components/uv-textarea/uv-textarea */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uv-textarea/components/uv-textarea/uv-textarea")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uv-textarea/components/uv-textarea/uv-textarea.vue */ 409))
    },
    ...
    uvToast: function () {
      return Promise.all(/*! import() | uni_modules/uv-toast/components/uv-toast/uv-toast */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uv-toast/components/uv-toast/uv-toast")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uv-toast/components/uv-toast/uv-toast.vue */ 449))
    },
...
var _default = {
  ...
  onLoad: function onLoad(e) {
    ...
    if (e.update != null && e.update) {
      ...
      var differenceDays = this.differenceTime(data.cancelTime, data.createAt);
      if (differenceDays <= 7) this.radioClick(0);else if (differenceDays <= 30) this.radioClick(1);else this.radioClick(2);
    } else {
      uni.setNavigationBarTitle({
        title: '发布闲置'
      });
  ...
  methods: {
    ...
    postShop: function postShop() {
      ...
      var resultShopDetail = this.shopDetailText.replace(/\n/g, '<br/>');
      this.post({
