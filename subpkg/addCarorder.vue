  ...
  <!--          <view class="input-container">
                ...
                <view class="input-container-right">
                    <uni-easyinput :inputBorder="false" type="tel" maxlength="15" placeholder="请输入手机号"
                        placeholderStyle="font-size: 34rpx; " :class="{ 'error': phoneError }" style="padding-left: 0;"
                        v-model="phoneNumber" />
            ...
            <view class="choseTimeDifference">
                <view class="choseTimeDifference-item">
                    <uv-checkbox-group>
                        <uv-checkbox @change="tiqianChange" activeColor="#87d7e1" name="tiqian" size="40rpx"
                            labelSize="17" labelColor="#584c48" label="能否接受提前出发"></uv-checkbox>
                    </uv-checkbox-group>
                    <view :class="isBefore == true ? 'truebeforeTime':'flasebeforeTime'" style=""
                        @click="openBeforDatetimePicker">
                        {{beforeTime}}
                    </view>
                    <uv-datetime-picker ref="beforDatetimePicker" v-model="beforeTime" mode="time"
                        @confirm="beforConfirm">
                    </uv-datetime-picker>
                </view>
                <view class="choseTimeDifference-item">
                    <uv-checkbox-group>
                        <uv-checkbox @change="yanhoChange" activeColor="#87d7e1" name="tiqian" size="40rpx"
                            labelSize="17" labelColor="#584c48" label="能否接受延后出发"></uv-checkbox>
                    </uv-checkbox-group>
                    <view :class="isAfter == true ? 'truebeforeTime':'flasebeforeTime'" style=""
                        @click="openAfterDatetimePicker">
                        {{afterTime}}
                    </view>
                    <uv-datetime-picker ref="afterDatetimePicker" v-model="afterTime" mode="time"
